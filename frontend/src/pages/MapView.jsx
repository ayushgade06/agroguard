          ...
          <div className="w-full max-w-lg bg-white rounded-[2.5rem] p-8 shadow-[0_0_100px_rgba(0,0,0,0.3)] border border-slate-200 animate-in zoom-in-95 duration-200">
             <div className="flex justify-between items-center mb-8">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="text-2xl font-black text-slate-900 tracking-tight leading-none mb-1">Hybrid Local Scan</h3>
                        <p className="text-xs text-slate-400 font-bold uppercase tracking-widest">Vision + Weather Analytics</p>
                    </div>
                </div>
             ...
             {!hybridResult || isHybridAnalyzing ? (
               ...
               <div className="space-y-6">
                  ...
                  <button 
                     ...
                     className="w-full py-4 bg-slate-100 text-slate-600 rounded-2xl text-xs font-black hover:bg-slate-200 transition-colors uppercase tracking-widest"
                  >
